...
GET_SIM_DETAILS=getSimDetails.sh
GET_JQ_TAR=jq-1.0.1.tar
...
cat $csvFile | grep -e "NSCS_ISSUE-REISSUE_ESC - Leptons" -e "NSCS_TRUST_ESC - Leptons" -e "NSCS_TRUST_SCU - Leptons" -e "NSCS_CREDENTIAL_SNMPV3_SCU - Leptons" -e "NSCS_ISSUE-REISSUE_SCU - Leptons" -e "Node Security CrlCheck - Abhedya" -e "Node_Security_SkyFall" -e "Security" -e "NSCS_CRLCHECK" -e "NSCS_SL2" -e "Node_Security-The16thFloor" -e "PKI_Security_Design_NIRVANA" -e "Node Security_RTSEL - Nirvana" -e "NSCS_IPSEC_CLI" -e "NSCS_LDAP - Skyfall" -e "External IdP - Skyfall" -e "Skyfall" -e "NSCS_LDAP" -e "NETLOG_Cosmos" -e "NSCS_ISSUE-REISSUE" -e "FTPES" -e "NSCS" | grep -e "ESC" -e "SCU" -e "RadioNode" -e "Router6471" -e 'FRONTHAUL-6020' | grep -v "NSCS_SSO - Leptons,n,n,FRONTHAUL-6020" | awk -F "," '{ printf "%s %s\n", $7, "RadioNode" }' | sort --unique > $NODES_INFO_FILE

cat $csvFile | grep -e "Node Security CrlCheck - Abhedya" -e "Node_Security_SkyFall" -e "Security" -e "NSCS_CRLCHECK" -e "NSCS_SL2" -e "Node_Security-The16thFloor" -e "PKI_Security_Design_NIRVANA" -e "Node Security_RTSEL - Nirvana" -e "NSCS_IPSEC_CLI" -e "NSCS_LDAP - Skyfall" -e "External IdP - Skyfall" -e "Skyfall" -e "FTPES" -e "NSCS" -e "NSCS_ISSUE-REISSUE - Chargers" -e "NSCS_ISSUE-REISSUE - Nirvana" | grep -e "ERBS,CPP" -e "MGW,CPP" -e "MRS,CPP" | grep -vE 'NSCS_TRUST - Venus,n,n,MGW,CPP,,|NSCS_CREDENTIAL - Raisers,n,n,MGW,CPP,,' | awk -F "," '{ printf "%s %s\n", $7, "ERBS" }' | sort >> $NODES_INFO_FILE
