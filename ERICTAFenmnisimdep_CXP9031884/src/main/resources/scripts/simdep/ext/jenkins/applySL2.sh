...
function help {
    ...
    HELP:
        Used to reapply SL2 certs after initial installation of ENM for vFarm and vApp servers.
...
#   Local variables
###################################################################################
setupSecurityScript=setupSecuritySL2.sh
...
EOF
    ...
    then
        echo "[ERROR] Failed to apply SL2 Security for $hostName"
        exit 1
    fi
done
